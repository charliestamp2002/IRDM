...
#negative sampling for consistency with other three implementations.
...
if __name__ == "__main__":
    ...
    validation_df = negative_sampling(validation_df, neg_ratio = 10)
    ...
    queries_df = validation_df[['qid', 'queries']].drop_duplicates(subset = ["qid"])
